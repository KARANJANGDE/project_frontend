...
const UserProjectListStatus = () => {
    ...
    const getImageName = (index) => {
      switch(index) {
        case 0: return 'Ratnakar3.jpg';
        case 1: return 'Shivalik3.jpg';
        case 2: return 'Shukun3.jpg';
  ...
  //         <h3 className="card-title">Project Status Management</h3>
  ...
  //                             <Link
  //                     to={`/user/userprojectstatus/${project._id}`}
  ...
  <div>
    <header style={{ textAlign: 'center', margin: '20px 0' }}>
      <h2>Project Status Management</h2>
      <p>View Your Projects Status</p>
      </header>
        ...
        >
          <div style={getProjectImageStyle(index)}>
            ...
            <div style={{...projectInfoStyle, opacity: hoverIndex === index ? 1 : 0}}>
              <h3 style={{position:'relative',top:"20%"}}>Here is the Status information about the {project.ProjectName}. You can look for the project status by clicking on the status button.</h3>
              <Link to={`/user/userprojectstatus/${project._id}`} style={projectStatusStyle}>
                Status
              </Link>
            </div>
          </div>
...
export default UserProjectListStatus
